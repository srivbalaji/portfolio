...
const SECTION_ENDS = {
  ...
  /** Merged Work tab — settle on former experience framing */
  work: { pos: [-0.92, 2.08, 1.38], look: [0, 1.36, 0], mechRotY: -0.32 },
...
export function getSectionCamera(section, phase = 'end') {
  const key = section === 'projects' || section === 'experience' ? 'work' : section
  const entry = SECTION_CAMERAS[key]
